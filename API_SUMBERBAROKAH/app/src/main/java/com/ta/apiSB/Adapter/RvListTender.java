...
public class RvListTender extends RecyclerView.Adapter<RvListTender.LisHolder> {
    Context context;
    ...
    class LisHolder extends RecyclerView.ViewHolder {   //disini tempat untuk inisialisasi
        ...
        public LisHolder(View itemView) {
            ...
            cvListKontrak = (CardView)itemView.findViewById(R.id.cv_listkontrak);
    ...
    public RvListTender(Context context, List<ListDataItemTender> listData, String URL, SessionManager mSession){
    ...
    @NonNull
    @Override
    public RvListTender.LisHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_kontrak, null, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull RvListTender.LisHolder lisHolder, int i) {
        ...
        lisHolder.cvListKontrak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(context, DetailKontrakActivity.class);
                in.putExtras(args);
