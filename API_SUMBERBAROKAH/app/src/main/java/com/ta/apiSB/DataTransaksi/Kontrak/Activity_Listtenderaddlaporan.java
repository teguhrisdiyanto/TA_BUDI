...
import com.ta.apiSB.Adapter.RvListTenderaddlaporan;
...
public class Activity_Listtenderaddlaporan extends AppCompatActivity {
    ...
    RvListTenderaddlaporan mRvListTenderlapor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__listtenderaddlaporan);
            ...
            public void onResponse(Call<ResponseTender> call, Response<ResponseTender> response) {
                ...
                else
                {
                    ...
                    if (statusCode.equals("00"))
                    {
                        ...
                        mRvListTenderlapor = new RvListTenderaddlaporan(getApplicationContext(), listDatatender, URL, mSession);
                        rvListKontrak.setAdapter(mRvListTenderlapor);
